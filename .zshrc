...
export PATH=$HOME/embedded/gcc-arm-none-eabi-5_4-2016q3/bin:$PATH

# End of lines added by compinstall
# export PS1="$(print '%{\e[1;32m%}%n@%M%{\e[0m%}:%~') %% "
# export RPS1="$(print '%{\e[1;30m%}[%T]%{\e[0m%}')"
# PROMPT='[%F{blue}%n%f@%F{blue}%M%f %B%F{yellow}%0~%f%b] 
# %B%F{green}:>%f%b '
PROMPT='%B%F{green}┏%f%b[%F{blue}%n%f@%F{blue}%M%f %B%F{yellow}%0~%f%b]'$'\n''%B%F{green}┗▶%f%b '
# PROMPT='%B%F{green}%f%b[%F{blue}%n%f@%F{blue}%M%f %B%F{yellow}%0~%f%b]:> '
# RPROMPT='%t'
